...
void AGun::OnFire()
{
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
				...
				auto projectile  = World->SpawnActor<AUdemyFPSProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
				//projectile->SetActorScale3D(FVector(1, 1, 1));
				//World->SpawnActor<AUdemyFPSProjectile>(ProjectileClass);
		}
	}
